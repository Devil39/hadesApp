...
//  bool isLoggedIn;
 Future<dynamic> signUp({String email, String password, String first_name, String last_name, String phone_number, String description}) async {
   var statuscode;
   var message;
   try{
 ...
 void testHive() async {
   final userDataBox= await Hive.openBox('userData');
   userDataBox.put('token', "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNvbWVvbmVAZ21haWwuY29tIiwib3JnX2lkIjowfQ.h9MhBU8OALtPuD3eo41jbE2Xdot_dTVLmuNEyWm-9lg");
   print("Token saved!");
   print(userDataBox.get('token'));
   Hive.close();
 }
