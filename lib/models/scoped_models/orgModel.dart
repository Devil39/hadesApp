...
mixin OrgModel on Model{
        ...
        if(response.statusCode==200)
         {
          ...
          if(response.statusCode==400 || response.statusCode==400 || response.statusCode==404)
           {
             throw "Server Error!";
           }
          else{
  ...
  Future<dynamic> createOrg({String name, String location, String description, String tag="", String website, String token}) async {
  ...
  Future<dynamic> getAllOrg(String token) async {
    ...
    if(orgDataBox.get("allOrgsList")!=null && orgDataBox.get("allOrgsList").length>0)
     {
  ...
  Future<dynamic> getAllReqOfOrg(String token, int orgId, String website) async {
    //{"code":200,"message":"Join request created successfully"}
    var body= jsonEncode({
      "org_id": orgId,
      "email": website
